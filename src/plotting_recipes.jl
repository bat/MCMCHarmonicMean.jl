...
@recipe function f(data::HMIData, dim1::Integer = 1, dim2::Integer = 2; rscale = 0.5,
        plot_seedsamples = true, plot_seedcubes = false, plot_samples = true,
        plot_acceptedrects = true, plot_rejectedrects = false, custom_title="", plot_datasets=0)
    ...
    titlefont := Plots.font("sans-serif", 28)
    guidefont := Plots.font("sans-serif", 24)
    tickfont  := Plots.font("sans-serif", 20)
    legendfont:= Plots.font("sans-serif", 16)
    legend := :topright
